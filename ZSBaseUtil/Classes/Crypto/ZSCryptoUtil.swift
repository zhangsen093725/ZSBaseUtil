//
//  ZSEncryptionUtil.swift
//  Pods-ZSBaseUtil_Example
//
//  Created by 张森 on 2019/10/20.
//
...
public extension Data {
    ...
    func zs_aesEncoded(is method: ZSCrypto = .aes128,
                       key: String,
                       iv: String) -> Data? {
        return zs_aes(operation: CCOperation(kCCEncrypt), is: method, key: key, iv: iv)
    }
    
    func zs_aesDecoded(is method: ZSCrypto = .aes128,
                       key: String,
                       iv: String) -> Data? {
        return zs_aes(operation: CCOperation(kCCDecrypt), is: method, key: key, iv: iv)
    }
    
    private func zs_aes(operation: CCOperation,
                        is method: ZSCrypto = .aes128,
                        key: String,
                        iv: String) -> Data? {
