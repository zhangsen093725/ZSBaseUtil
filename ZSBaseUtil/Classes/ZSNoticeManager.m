...
- (void)addObservers{
    NSDictionary *dict = [[NSMutableDictionary dictionaryWithObjectsAndKeys:
                           SEL_VALUE(enterBackground),        UIApplicationDidEnterBackgroundNotification,
                           SEL_VALUE(enterForeground),        UIApplicationWillEnterForegroundNotification,
                           SEL_VALUE(keyboardWillShow:),      UIKeyboardWillShowNotification,
                           SEL_VALUE(keyboardWillHide:),      UIKeyboardWillHideNotification,
                           nil] copy];
